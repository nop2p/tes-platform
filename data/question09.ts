...
export const questions: Question[] = [
  ...
  },
  {
    ...
    answer: CHOICE_IDS.D,
    explanation: {
      text: "ตามมาตรฐาน วสท. 2564 (บทที่ 1 นิยาม) ได้อ้างอิงระดับแรงดันตามมาตรฐานสากล IEC โดยระบุว่า แรงต่ำ (Low Voltage) หมายถึงแรงดันไฟฟ้ากระแสสลับ ไม่เกิน 1000 V (U₀ ≤ 600 V / U ≤ 1000 V) ดังนั้น ระบบแรงสูง (High Voltage) สำหรับระบบไฟฟ้ากระแสสลับ จึงหมายถึงระบบที่มีค่าแรงดันเฟสเทียบกับดินหรือแรงดันระหว่างสาย เกิน 1,000 โวลต์ขึ้นไป",
    },
    difficulty: DIFFICULTY.EASY,
    tags: [
      "มาตรฐานการติดตั้งไฟฟ้าสำหรับประเทศไทย 2564",
  ...
  },
  {
    ...
    answer: CHOICE_IDS.C,
    explanation: {
      text: "ตามมาตรฐาน วสท. 2564 (บทที่ 3 การคำนวณโหลด):\nเต้ารับใช้งานทั่วไปชนิดเต้าเดี่ยว/เต้าคู่ = 180 VA\nเต้ารับชนิดสามเต้า (Triplex) หรือ ชนิดสี่เต้า (Quadruplex) ที่อยู่บนแป้นเดียวกัน ให้คำนวณโหลดจุดละ 360 VA (คิดจาก 180 VA × 2)",
    },
    difficulty: DIFFICULTY.EASY,
    tags: [
      "มาตรฐานการติดตั้งไฟฟ้าสำหรับประเทศไทย 2564",
  ...
  },
  {
    ...
    answer: CHOICE_IDS.C,
    explanation: {
      text: "ใช้สูตรสามเหลี่ยมกำลังไฟฟ้า S = √(P² + Q²):\nP = 600 kW\nQ = 800 kVAR\nแทนค่า:\nS = √(600² + 800²) = √(360,000 + 640,000) = √1,000,000 = 1,000 kVA",
    },
    difficulty: DIFFICULTY.EASY,
    tags: [
      "มาตรฐานการติดตั้งไฟฟ้าสำหรับประเทศไทย 2564",
  ...
  },
  {
    ...
    answer: CHOICE_IDS.D,
    explanation: {
      text: "หากำลังไฟฟ้าปรากฏ (S):\nS = √(P² + Q²) = √(800² + 500²) = √(640,000 + 250,000) = √890,000 ≈ 943.398 kVA\nหาค่า Power Factor (PF):\nPF = P ÷ S = 800 ÷ 943.398 ≈ 0.8480 = 84.8%",
    },
    difficulty: DIFFICULTY.EASY,
    tags: [
      "มาตรฐานการติดตั้งไฟฟ้าสำหรับประเทศไทย 2564",
  ...
  },
  {
    ...
    topicId: TOPIC_IDS.ThaiElectricalCode2021,
    order: 44,
    question: "รางเดินสายขนาด 100 × 100 มม. สามารถบรรจุสาย IEC 01 มีพื้นที่หน้าตัดของตัวนำรวมฉนวน 73.8 ตร.มม. ได้มากสุดจำนวนกี่เส้น",
    choices: [
      {
        id: CHOICE_IDS.A,
        text: "25",
  ...
  },
  {
    ...
    topicId: TOPIC_IDS.ThaiElectricalCode2021,
    order: 72,
    question: "ต้องการร้อยสาย IEC 01 จำนวน 5 เส้นซึ่งมีรายละเอียดดังนี้ 3 × 240 ตร.มม. (สาย 240 ตร.มม. มีพื้นที่หน้าตัดรวมฉนวน 556 ตร.มม.), 1 × 120 ตร.มม. (สาย 120 ตร.มม. มีพื้นที่หน้าตัดรวมฉนวน 278 ตร.มม.), G-25 ตร.มม. (สาย 25 ตร.มม. มีพื้นที่หน้าตัดรวมฉนวน 73.8 ตร.มม.) จะต้องใช้ท่อขนาดเล็กสุดเท่าใด",
    choices: [
      {
        id: CHOICE_IDS.A,
  ...
  },
  {
    ...
    answer: CHOICE_IDS.C,
    explanation: {
      text: "เมื่อกระแสไฟฟ้าไหลผ่านสายที่มีขนาดเล็กกว่าพิกัด กำลังไฟฟ้าสูญเสียในรูปความร้อน (I²R) จะสูงขึ้น ส่งผลให้เกิด ความร้อนสะสมในตัวนำและฉนวน เป็นอันดับแรก ซึ่งความร้อนสะสมนี้นานวันเข้าจะทำให้ฉนวนกรอบ แตกร้าว เสื่อมสภาพ (Insulation Degradation) และนำไปสู่การลัดวงจรหรือเพลิงไหม้ตามมาในที่สุด",
    },
    difficulty: DIFFICULTY.EASY,
    tags: [
      "มาตรฐานการติดตั้งไฟฟ้าสำหรับประเทศไทย 2564",
